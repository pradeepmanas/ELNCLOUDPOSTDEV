...
//			LSSiteMaster lssitemaster, int m, Integer pageperorder,Integer approvelstatus);
	...
	@Query(value = "WITH TeamProjects AS ( " +
	        ...
	        "       AND " +
				        "( " +
				    		...
				    		"(viewoption = ?8) AND " +
				    		"( " +
				    		    "(teamselected = true AND batchcode IN ?14)" +
				    		") " +
				    		") " +
				    		"OR " +
				    		"( " +
	...
	List<LSlogilablimsorderdetail> getLSlogilablimsorderdetaildashboardforpending(String string, int i, Date fromdate,
			Date todate, LSuserMaster objuser, int j, int k, int l,List<LSuserMaster> usernotify,
			LSSiteMaster lssitemaster, int m, Integer pageperorder,Integer approvelstatus,List<Long> batchcode);
	...
	@Query(value = "WITH TeamProjects AS ( " +
			...
			"       AND (viewoption = ?8 AND teamselected = true AND batchcode IN ?12) " +
			"   ) " +
	        "   OR (lsprojectmaster_projectcode IS NULL AND ordercancell IS NULL AND assignedto_usercode IS NULL AND (o.Approvelstatus != ?11 OR o.Approvelstatus IS NULL) " +
	...
	long countLSlogilablimsorderdetaildashboardforpending(String string, int i, Date fromdate,
	        Date todate, LSuserMaster objuser, int j, int k, int l, List<LSuserMaster> usernotify,
	        LSSiteMaster lssitemaster,Integer approvelstatus,List<Long> selectedbatchcodelist);
...
//	List<Logilaborders> findByLsfileIn(List<LSfile> files);
	...
	List<Logilaborders> findByDirectorycodeAndViewoptionAndLsuserMasterAndCreatedtimestampBetweenOrDirectorycodeAndViewoptionAndLsuserMasterAndCreatedtimestampBetweenOrderByBatchcodeDesc(
			Long directorycode, int i, LSuserMaster createdby, Date fromdate, Date todate, Long directorycode2, int j,
			LSuserMaster createdby2, Date fromdate2, Date todate2);

	List<Logilaborders> findByDirectorycodeAndViewoptionAndCreatedtimestampBetweenAndLsuserMasterOrderByBatchcodeDesc(
	...
	long (
			int i, List<LSprojectmaster> lstproject, Date fromdate, Date todate, int j, LSuserMaster objuser,
			Date fromdate2, Date todate2, int k, int l, LSuserMaster objuser2, Date fromdate3, Date todate3, int m,
			int n, LSuserMaster objuser3, Date fromdate4, Date todate4, int o, boolean b, LSuserMaster objuser4,
			LSuserMaster objuser5, Date fromdate5, Date todate5, int p, LSuserMaster objuser6, Date fromdate6,
			Date todate6, int q);

	long (
			String string, int i, Date fromdate, Date todate, String string2, int j, LSuserMaster objuser,
			Date fromdate2, Date todate2, int k, String string3, int l, LSuserMaster objuser2, Date fromdate3,
			Date todate3, int m, String string4, int n, LSuserMaster objuser3, Date fromdate4, Date todate4,
			String string5, int o, LSuserMaster objuser4, Date fromdate5, Date todate5, String string6, int p,
			LSuserMaster objuser5, Date fromdate6, Date todate6, boolean b, String string7, LSuserMaster objuser6,
			LSuserMaster objuser7, Date fromdate7, Date todate7, String string8, LSuserMaster objuser8, Date fromdate8,
			Date todate8);
	...
	long (
			...
			Date todate3, LSuserMaster objuser2, String string3, List<Long> directorycode3, int l, Date fromdate4,
			Date todate4, LSuserMaster objuser3, String string4, boolean c, int m, boolean d,
			...
			Date todate6, LSuserMaster objuser5, String string6);

	List<LogilabOrdermastersh> (
			int i, Date fromdate, Date todate, LSuserMaster objuser, String string, int j, int k, Date fromdate2,
			Date todate2, LSuserMaster objuser2, String string2, boolean b, List<Long> directorycode, int l,
			Date fromdate3, Date todate3, String string3, int m, List<Long> directorycode2, int n, Date fromdate4,
			Date todate4, String string4, List<Long> directorycode3, int o, Date fromdate5, Date todate5,
			LSuserMaster objuser3, String string5, int p, List<Long> directorycode4, int q, Date fromdate6,
			Date todate6, LSuserMaster objuser4, String string6, List<Long> directorycode5, int r, Date fromdate7,
			Date todate7, LSuserMaster objuser5, String string7, int s, List<Long> directorycode6, int t,
			Date fromdate8, Date todate8, LSuserMaster objuser6, String string8, boolean c, int u, boolean d,
			List<Long> selectedteambatchCodeList, Date fromdate9, Date todate9, LSuserMaster objuser7, String string9,
			List<Long> directorycode7, boolean e, List<Long> selectedteambatchCodeList2, int v, Date fromdate10,
			Date todate10, LSuserMaster objuser8, String string10, Pageable pageable);

	long (
			int i, Date fromdate, Date todate, LSuserMaster objuser, String string, int j, int k, Date fromdate2,
			Date todate2, LSuserMaster objuser2, String string2, boolean b, List<Long> directorycode, int l,
			Date fromdate3, Date todate3, String string3, int m, List<Long> directorycode2, int n, Date fromdate4,
			Date todate4, String string4, List<Long> directorycode3, int o, Date fromdate5, Date todate5,
			...
			Date todate6, LSuserMaster objuser4, String string6, List<Long> directorycode5, int r, Date fromdate7,
			Date todate7, LSuserMaster objuser5, String string7, int s, List<Long> directorycode6, int t,
			Date fromdate8, Date todate8, LSuserMaster objuser6, String string8, boolean c);

	List<LogilabOrdermastersh> (
			int i, Date fromdate, Date todate, LSuserMaster objuser, int j, boolean b, int k, boolean c,
			List<Long> selectedteambatchCodeList, Date fromdate2, Date todate2, LSuserMaster objuser2, int l,
			List<Long> directorycode, int m, Date fromdate3, Date todate3, int n, List<Long> directorycode2, int o,
			Date fromdate4, Date todate4, LSuserMaster objuser3, int p, List<Long> directorycode3, int q,
			Date fromdate5, Date todate5, LSuserMaster objuser4, int r, boolean d, List<Long> directorycode4, boolean e,
			List<Long> selectedteambatchCodeList2, int s, Date fromdate6, Date todate6, LSuserMaster objuser5, int t,
			Pageable pageable);

	long (
			int i, Date fromdate, Date todate, LSuserMaster objuser, int j, boolean b, List<Long> directorycode, int k,
			Date fromdate2, Date todate2, int l, List<Long> directorycode2, int m, Date fromdate3, Date todate3,
			LSuserMaster objuser2, int n, List<Long> directorycode3, int o, Date fromdate4, Date todate4,

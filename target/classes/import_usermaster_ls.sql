...
--insert into LSusergroup(createdby, createdon, modifiedby, modifiedon, usergroupname, usergroupstatus, lssitemaster_sitecode)values('administrator', NOW(),'administrator', NOW(),'Azure aads', 'A',1);
